**This fork enables this beautiful tool to be used with Dapr bindings as a DBMS. Since the base classes are internal, extending the tool without forking is not possible**
